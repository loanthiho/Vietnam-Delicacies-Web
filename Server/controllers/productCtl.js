const { createProduct, getAllProduct, getDetailProduct, updateProduct, removeProduct } = require('../services/productServices')
...
const getOne = (req, res, next) => getDetailProduct(req, res, next);
